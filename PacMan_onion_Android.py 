#onion by PacMan (Andrij Shvets) v1.1.1 [Android]
...
print("PacMan")
print("(Andrij Shvets)")
print("v1.1.1 [Android]  ")
print("")
print("")
print("")
print("v1.1.1 [Android] (Это первая версия программы и, возможно, будут баги,ошибки и.т.д.) ")
print("")
...
what = input ("/")
if what == "info":
    print("Github: https://github.com/Aggggsu")
